...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jcontacts_csvLabel0 = new JLabel();
	JTextField jcontacts_csvTextField0 = new JTextField();

	JLabel jcontacts2Label1 = new JLabel();
	JTextField jcontacts2TextField1 = new JTextField();
	...
	protected void fillScrollPane() {
		...
		jcontacts_csvLabel0.setText("Source instance of contacts-csv file:");
		jcontacts_csvLabel0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jcontacts_csvLabel0, null);
		jcontacts_csvTextField0.setText("C:/Users/ahmadtaufik/Desktop/contacts/input1.csv");
		jcontacts_csvTextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jcontacts_csvTextField0.setEditable(false);
		jPanelStructures.add(jcontacts_csvTextField0, null);

		jcontacts2Label1.setText("Instance of contacts.xsd:");
		jcontacts2Label1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jcontacts2Label1, null);
		jcontacts2TextField1.setText("output1.xml");
		jcontacts2TextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jcontacts2TextField1.setEditable(false);
		jPanelStructures.add(jcontacts2TextField1, null);
